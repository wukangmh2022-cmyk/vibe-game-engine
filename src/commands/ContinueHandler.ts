 ...
 * 用于跳过当前循环迭代，继续下一次迭代
 */
export class ContinueHandler extends BaseCommandHandler {
  readonly type = CommandType.CONTINUE;
  ...
  async execute(command: GameCommand, context: CommandContext): Promise<CommandResult> {
    try {
      ...
      context.logger.error('Continue execution failed', { error: errorMessage, command });
