#!/usr/bin/env bash
# Collect adapter generations for the balanced human-fragment benchmark.
set -euo pipefail
...
TIMEOUT="${TIMEOUT:-180}"
RUN_LABEL="${RUN_LABEL:-adapter-human-fragment-v1}"
...
export VIBE_EVAL_ADAPTER_MODEL="${VIBE_EVAL_ADAPTER_MODEL:-vibe-level-qwen3-4b-dsl-v3}"
